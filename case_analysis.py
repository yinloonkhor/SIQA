...
def main() -> None:
    checkpoint_dir = Path("checkpoints/qwen3-vl-2b-siqa-mixed-lora_from_domain_frac_40/best")
    input_path = Path("images_case/case.jsonl")
    root = Path("images_case")
    output_path = Path("case_analysis/DoubleY_data_SIQA-S.json")
    team = "DoubleY"
    method = "data"
